        ...
        <div className=''>
            <footer className="footer bg-neutral border-t-4 border-green-300 text-neutral-content items-center p-4">
                ...
                <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end text-2xl">
                    <a>
                        <FaTwitter className='hover:text-green-300'></FaTwitter>
                    </a>
                    <a>
                        <FaYoutube className='hover:text-green-300'></FaYoutube>
                    </a>
                    <a>
                        <FaFacebookF className='hover:text-green-300'></FaFacebookF>
                    </a>
                </nav>
            </footer>
        </div>
